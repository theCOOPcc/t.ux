...
const ConfirmationForm = ({ sections, topic }) => {
    ...
    return (
        <>
            ...
            <Div>
                ...
                <Heading3 activityTitle>{topic} Activity.</Heading3>
                <Line></Line>
                <Heading3 formTitle>Feedback for your instructor</Heading3>
                <U.Normal lineTwentySeven>Check the boxes blow next to concepts you feel confident <br /> about after completing this activity:</U.Normal>
                <Formik
                ...
                >
                    {({ values, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
                        <Form onSubmit={handleSubmit} className="centerCheckboxes">
                            ...
                            <U.Normal sixteen semiBold darkGrey margin margin50> Additional Questions or Comments for your instructor?</U.Normal>
                            <U.TextArea name="comment" type="textarea" value={values.comment} onChange={handleChange}
                            />
