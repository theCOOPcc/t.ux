          ...
          <!DOCTYPE html>
            ...
            <body style="margin: 0; background: rgba(255, 255, 255, 1)">
                ...
                <div class="arrows-C61RwL">
                    ...
                    <img class="line-xyzGYC" src="img/line@1x.png" />
                    <div class="end-circle-xyzGYC"><img class="circle-Y2m0dH" src="img/circle@2x.png" /></div>
                    <div class="end-arrow-xyzGYC"><img class="arrow-V64ixE" src="img/arrow@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-VMr6Om">
                    <div class="arrows-k63xqQ">
                    <img class="line-FIkP59" src="img/line-1@1x.png" />
                    <div class="end-circle-FIkP59"><img class="circle-K5xWjC" src="img/circle-1@2x.png" /></div>
                    <div class="end-arrow-FIkP59"><img class="arrow-pYhnqA" src="img/arrow-1@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-mzXdH9">
                    <div class="arrows-Jq80WT">
                    <img class="line-GjMvlA" src="img/line-2@1x.png" />
                    <div class="end-circle-GjMvlA"><img class="circle-s6JKa3" src="img/circle-2@2x.png" /></div>
                    <div class="end-arrow-GjMvlA"><img class="arrow-yjuGQ2" src="img/arrow-2@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-QxM5SU">
                    <div class="straight-RN3tVf">
                    <img class="x-BbwkIO" src="img/-@1x.png" />
                    <div class="end-arrow-BbwkIO"><img class="arrow-ciuQSm" src="img/arrow-3@2x.png" /></div>
                    <div class="end-circle-BbwkIO"><img class="circle-RprOp1" src="img/circle-3@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-2P4qUJ">
                    <div class="arrows-uEHKQf">
                    <img class="line-V50siW" src="img/line-3@1x.png" />
                    <div class="end-circle-V50siW"><img class="circle-jhlCFz" src="img/circle-4@2x.png" /></div>
                    <div class="end-arrow-V50siW"><img class="arrow-VKDAsf" src="img/arrow-4@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-qr8e7q">
                    <div class="arrows-OoCC4Z">
                    <img class="line-nbGgow" src="img/line-5@1x.png" />
                    <div class="end-circle-nbGgow"><img class="circle-fNDTVt" src="img/circle-5@2x.png" /></div>
                    <div class="end-arrow-nbGgow"><img class="arrow-vvzelS" src="img/arrow-5@2x.png" /></div>
                    </div>
                </div>
                <div class="straight-C61RwL">
                    <img class="x-FLZs8k" src="img/-@2x.png" />
                    <div class="end-arrow-FLZs8k"><img class="arrow-fH50B9" src="img/arrow-6@2x.png" /></div>
                    <div class="end-circle-FLZs8k"><img class="circle-ezCUt6" src="img/circle-6@2x.png" /></div>
                </div>
                <div class="arrows-J1YQmd">
                    <div class="arrows-xL517Z">
                    <img class="line-77EOdN" src="img/line-6@1x.png" />
                    <div class="end-circle-77EOdN"><img class="circle-M6tyV3" src="img/circle@2x.png" /></div>
                    <div class="end-arrow-77EOdN"><img class="arrow-EpeAAN" src="img/arrow-7@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-a5WPlX">
                    <div class="arrows-xxPnZw">
                    <img class="line-NxraJ0" src="img/line-7@1x.png" />
                    <div class="end-circle-NxraJ0"><img class="circle-if9zBr" src="img/circle-8@2x.png" /></div>
                    <div class="end-arrow-NxraJ0"><img class="arrow-xtxcog" src="img/arrow-8@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-HlKRTo">
                    <div class="arrows-AqJEqU">
                    <img class="line-pZEISt" src="img/line-8@1x.png" />
                    <div class="end-circle-pZEISt"><img class="circle-64h8qX" src="img/circle-9@2x.png" /></div>
                    <div class="end-arrow-pZEISt"><img class="arrow-5TTYTv" src="img/arrow-9@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-VkPPtx">
                    <div class="arrows-CTgWnK">
                    <img class="line-N8VbF9" src="img/line-9@1x.png" />
                    <div class="end-circle-N8VbF9"><img class="circle-GW9AFU" src="img/circle-10@2x.png" /></div>
                    <div class="end-arrow-N8VbF9"><img class="arrow-vNxSfx" src="img/arrow-10@2x.png" /></div>
                    </div>
                </div>
                <div class="straight-VMr6Om">
                    <img class="x-Qrtl8p" src="img/-@2x.png" />
                    <div class="end-arrow-Qrtl8p"><img class="arrow-9jZgs5" src="img/arrow-11@2x.png" /></div>
                    <div class="end-circle-Qrtl8p"><img class="circle-s3unbu" src="img/circle-11@2x.png" /></div>
                </div>
                <div class="arrows-YWzA7M">
                    <div class="straight-nrrmIW">
                    <img class="x-qIbqgp" src="img/-@2x.png" />
                    <div class="end-arrow-qIbqgp"><img class="arrow-qoN9IZ" src="img/arrow-12@2x.png" /></div>
                    <div class="end-circle-qIbqgp"><img class="circle-Zc68sm" src="img/circle-12@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-3kIbHG">
                    <div class="straight-4Cnj9O">
                    <img class="x-neAleF" src="img/-@2x.png" />
                    <div class="end-arrow-neAleF"><img class="arrow-oSre6K" src="img/arrow-12@2x.png" /></div>
                    <div class="end-circle-neAleF"><img class="circle-xXbFhQ" src="img/circle-12@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-a73nmY">
                    <div class="straight-xRxczN">
                    <img class="x-YMmEkW" src="img/-@2x.png" />
                    <div class="end-arrow-YMmEkW"><img class="arrow-xUkMIC" src="img/arrow-14@2x.png" /></div>
                    <div class="end-circle-YMmEkW"><img class="circle-krlFG6" src="img/circle-14@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-R7WrHk">
                    <div class="straight-IRCBUA">
                    <img class="x-B81KrX" src="img/-@2x.png" />
                    <div class="end-arrow-B81KrX"><img class="arrow-RoxMqt" src="img/arrow-15@2x.png" /></div>
                    <div class="end-circle-B81KrX"><img class="circle-xMSK42" src="img/circle-15@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-rxvq3k">
                    <div class="straight-VeMWtl">
                    <img class="x-7SuQQW" src="img/-@2x.png" />
                    <div class="end-arrow-7SuQQW"><img class="arrow-8VdKlP" src="img/arrow-16@2x.png" /></div>
                    <div class="end-circle-7SuQQW"><img class="circle-6riH4Z" src="img/circle-16@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-00LGpa">
                    <div class="straight-nwrCA7">
                    <img class="x-jeV6nn" src="img/-@2x.png" />
                    <div class="end-arrow-jeV6nn"><img class="arrow-SaugEM" src="img/arrow-17@2x.png" /></div>
                    <div class="end-circle-jeV6nn"><img class="circle-xx2egJ" src="img/circle-17@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-x5xjB4">
                    <div class="straight-hnlRxw">
                    <img class="x-hcxild" src="img/-@2x.png" />
                    <div class="end-arrow-hcxild"><img class="arrow-1Ee8tN" src="img/arrow-18@2x.png" /></div>
                    <div class="end-circle-hcxild"><img class="circle-jlFycb" src="img/circle-18@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-QL5zbd">
                    <div class="straight-StUVBj">
                    <img class="x-Uc3bIO" src="img/-@2x.png" />
                    <div class="end-arrow-Uc3bIO"><img class="arrow-bls4LO" src="img/arrow-19@2x.png" /></div>
                    <div class="end-circle-Uc3bIO"><img class="circle-qHaffj" src="img/circle-19@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-rzkej8">
                    <div class="straight-fQfPSS">
                    <img class="x-jTFAAL" src="img/-@2x.png" />
                    <div class="end-arrow-jTFAAL"><img class="arrow-qNkBU2" src="img/arrow-20@2x.png" /></div>
                    <div class="end-circle-jTFAAL"><img class="circle-xsWxhn" src="img/circle-20@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-eCxQ2N">
                    <div class="straight-UHfHL9">
                    <img class="x-ixr2pu" src="img/-@2x.png" />
                    <div class="end-arrow-ixr2pu"><img class="arrow-n2KMxq" src="img/arrow-21@2x.png" /></div>
                    <div class="end-circle-ixr2pu"><img class="circle-k6uuW4" src="img/circle-21@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-dMQSMw">
                    <div class="straight-Z3Bd6G">
                    <img class="x-dyxDQU" src="img/-@2x.png" />
                    <div class="end-arrow-dyxDQU"><img class="arrow-mva8kQ" src="img/arrow-22@2x.png" /></div>
                    <div class="end-circle-dyxDQU"><img class="circle-9l7LTZ" src="img/circle-22@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-MGnoC8">
                    <div class="straight-5lGawT">
                    <img class="x-0aO1VI" src="img/-@2x.png" />
                    <div class="end-arrow-0aO1VI"><img class="arrow-CwR3YI" src="img/arrow-23@2x.png" /></div>
                    <div class="end-circle-0aO1VI"><img class="circle-IY6ygl" src="img/circle-23@2x.png" /></div>
                    </div>
                </div>
                <div class="straight-mzXdH9">
                    <img class="x-iPQYgu" src="img/-@2x.png" />
                    <div class="end-arrow-iPQYgu"><img class="arrow-TZ9Exm" src="img/arrow-24@2x.png" /></div>
                    <div class="end-circle-iPQYgu"><img class="circle-C9ICD6" src="img/circle-24@2x.png" /></div>
                </div>
                <div class="arrows-K0Quix">
                    <div class="straight-bsrUp3">
                    <img class="x-N6pqu4" src="img/-@2x.png" />
                    <div class="end-arrow-N6pqu4"><img class="arrow-Fd1Dgl" src="img/arrow-25@2x.png" /></div>
                    <div class="end-circle-N6pqu4"><img class="circle-igEA4I" src="img/circle-25@2x.png" /></div>
                    </div>
                </div>
                <img class="arrows-oGxSr2" src="img/arrows@1x.png" />
                <div class="arrows-NjZa5V">
                    <img class="line-qTIc1H" src="img/line-10@1x.png" />
                    <div class="end-circle-qTIc1H"><img class="circle-VBxTSi" src="img/circle-25@2x.png" /></div>
                    <div class="end-arrow-qTIc1H"><img class="arrow-L0DJjq" src="img/arrow-26@2x.png" /></div>
                </div>
                <div class="arrows-JNxCmP">
                    <div class="straight-hm6SoA">
                    <img class="x-pflG9e" src="img/-@2x.png" />
                    <div class="end-arrow-pflG9e"><img class="arrow-5RgZvx" src="img/arrow-27@2x.png" /></div>
                    <div class="end-circle-pflG9e"><img class="circle-m9oihe" src="img/circle-27@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-NVuCL2">
                    <div class="straight-fDlEfQ">
                    <img class="x-Qv573z" src="img/-@2x.png" />
                    <div class="end-arrow-Qv573z"><img class="arrow-k9saW0" src="img/arrow-27@2x.png" /></div>
                    <div class="end-circle-Qv573z"><img class="circle-Tesj9r" src="img/circle-27@2x.png" /></div>
                    </div>
                </div>
                <div class="straight-QxM5SU">
                    <img class="x-53pGde" src="img/-@2x.png" />
                    <div class="end-arrow-53pGde"><img class="arrow-gWxjPS" src="img/arrow-29@2x.png" /></div>
                    <div class="end-circle-53pGde"></div>
                </div>
                <div class="arrows-uUmcMD">
                    <img class="x-D6XEqY" src="img/-@2x.png" />
                    <img class="x-jXfIdh" src="img/-@1x.png" />
                    <div class="end-circle-D6XEqY"><img class="circle-PFATD5" src="img/circle-25@2x.png" /></div>
                    <div class="end-arrow-D6XEqY"><img class="arrow-R23veA" src="img/arrow-30@2x.png" /></div>
                </div>
                <div class="arrows-sOxCtc">
                    <img class="x-wVBmTr" src="img/-@2x.png" />
                    <img class="x-RbyElE" src="img/-@1x.png" />
                    <div class="end-circle-wVBmTr"><img class="circle-OfEFdA" src="img/circle-25@2x.png" /></div>
                    <div class="end-arrow-wVBmTr"><img class="arrow-2mtH7D" src="img/arrow-30@2x.png" /></div>
                </div>
                <div class="arrows-V4bTox">
                    <div class="straight-XbotIx">
                    <img class="x-NuvwBY" src="img/-@2x.png" />
                    <div class="end-arrow-NuvwBY"><img class="arrow-QxU2w2" src="img/arrow-32@2x.png" /></div>
                    <div class="end-circle-NuvwBY"><img class="circle-QPHUNO" src="img/circle-31@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-Pmjxql">
                    <div class="straight-NiiWBv">
                    <img class="x-vFFAA6" src="img/-@2x.png" />
                    <div class="end-arrow-vFFAA6"><img class="arrow-rSYQDE" src="img/arrow-33@2x.png" /></div>
                    <div class="end-circle-vFFAA6"><img class="circle-6Z2x6E" src="img/circle-32@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-XZCSIE">
                    <div class="straight-k989eE">
                    <img class="x-DRE5oQ" src="img/-@2x.png" />
                    <div class="end-arrow-DRE5oQ"><img class="arrow-FqyqBX" src="img/arrow-34@2x.png" /></div>
                    <div class="end-circle-DRE5oQ"><img class="circle-xZxeJV" src="img/circle-33@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-fFhl4P">
                    <div class="straight-4bBlGY">
                    <img class="x-QgopHv" src="img/-@2x.png" />
                    <div class="end-arrow-QgopHv"><img class="arrow-Y8Vu52" src="img/arrow-34@2x.png" /></div>
                    <div class="end-circle-QgopHv"><img class="circle-x58iqR" src="img/circle-33@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-xsJokX">
                    <div class="straight-U97laX">
                    <img class="x-hvSJxm" src="img/-@2x.png" />
                    <div class="end-arrow-hvSJxm"><img class="arrow-8HDS7L" src="img/arrow-34@2x.png" /></div>
                    <div class="end-circle-hvSJxm"><img class="circle-EWg7nJ" src="img/circle-33@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-AViU91">
                    <img class="x-Wxfvkr" src="img/-@2x.png" />
                    <img class="x-hqJgpG" src="img/-@1x.png" />
                    <div class="end-circle-Wxfvkr"><img class="circle-HxPi7R" src="img/circle-25@2x.png" /></div>
                    <div class="end-arrow-Wxfvkr"><img class="arrow-9KOfAI" src="img/arrow-25@2x.png" /></div>
                </div>
                <div class="arrows-4yyt9N">
                    <div class="straight-w47nXc">
                    <img class="x-vxIQIV" src="img/-@2x.png" />
                    <div class="end-arrow-vxIQIV"><img class="arrow-XiQxux" src="img/arrow-38@2x.png" /></div>
                    <div class="end-circle-vxIQIV"><img class="circle-WilVx5" src="img/circle-37@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-4XW1xH">
                    <div class="straight-Ku5SWk">
                    <img class="x-d1MhVV" src="img/-@2x.png" />
                    <div class="end-arrow-d1MhVV"><img class="arrow-R2adEB" src="img/arrow-38@2x.png" /></div>
                    <div class="end-circle-d1MhVV"><img class="circle-wWjyMV" src="img/circle-37@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-ucCvyV">
                    <div class="straight-BvRG2a">
                    <img class="x-pNWzPk" src="img/-@2x.png" />
                    <div class="end-arrow-pNWzPk"><img class="arrow-yZP1J2" src="img/arrow-27@2x.png" /></div>
                    <div class="end-circle-pNWzPk"><img class="circle-EBBky8" src="img/circle-27@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-6y9Vs4">
                    <div class="straight-h7vOa8">
                    <img class="x-xDNiYj" src="img/-@2x.png" />
                    <div class="end-arrow-xDNiYj"><img class="arrow-pBJTIg" src="img/arrow-27@2x.png" /></div>
                    <div class="end-circle-xDNiYj"><img class="circle-ycr7Zt" src="img/circle-27@2x.png" /></div>
                    </div>
                </div>
                <div class="arrows-fxLfJc">
                    <div class="straight-vkgCvA">
                    <img class="x-xx5tTK" src="img/-@2x.png" />
                    <div class="end-arrow-xx5tTK"><img class="arrow-6jc168" src="img/arrow-27@2x.png" /></div>
                    <div class="end-circle-xx5tTK"><img class="circle-Z4uaac" src="img/circle-27@2x.png" /></div>
                    </div>
                </div>
                <div class="straight-2P4qUJ">
                    <img class="x-8k6xAd" src="img/-@2x.png" />
                    <div class="end-arrow-8k6xAd"><img class="arrow-gwgRCl" src="img/arrow-43@2x.png" /></div>
                    <div class="end-circle-8k6xAd"><img class="circle-uwJica" src="img/circle-42@2x.png" /></div>
                </div>
                <div class="straight-qr8e7q">
                    <img class="x-XOxNi0" src="img/-@2x.png" />
                    <div class="end-arrow-XOxNi0"><img class="arrow-DkpVx9" src="img/arrow-44@2x.png" /></div>
                    <div class="end-circle-XOxNi0"><img class="circle-DDFxpg" src="img/circle-43@2x.png" /></div>
                </div>
                <div class="straight-J1YQmd">
                    <img class="x-fm9YjI" src="img/-@1x.png" />
                    <div class="end-arrow-fm9YjI"><img class="arrow-oB0zZ2" src="img/arrow-44@2x.png" /></div>
                    <div class="end-circle-fm9YjI"><img class="circle-EdSul4" src="img/circle-43@2x.png" /></div>
                </div>
                <div class="straight-a5WPlX">
                    <img class="x-2afLls" src="img/-@2x.png" />
                    <div class="end-arrow-2afLls"><img class="arrow-FmLjec" src="img/arrow-46@2x.png" /></div>
                    <div class="end-circle-2afLls"><img class="circle-AvwTxe" src="img/circle-45@2x.png" /></div>
                </div>
                ...
                <img class="perceivable-image-C61RwL" src="img/perceivable-image@1x.png" />
                <img class="screen-sho--at-1021-1-C61RwL" src="img/screen-shot-2020-12-25-at-10-21-1@1x.jpg" />
                ...
                <img class="x0yno3-lx1t--lxxz7-p-1-C61RwL" src="img/0-yno3lx1ttxlxxz7p-1@1x.png" />
                <img class="x1v3-q-ducp-jns7-q-1-1-C61RwL" src="img/1-v3qducpnlpwr91sbbjns7q-1-1@1x.png" />
                <img class="vector-C61RwL" src="img/vector-18@2x.png" />
                <div class="divider-dotted-C61RwL"><img class="line-4-xv1xHo" src="img/line-4-4@1x.png" /></div>
                <div class="welcome-C61RwL">
          ...
          <!DOCTYPE html>
            ...
            <body style="margin: 0; background: rgba(255, 255, 255, 1)">
                ...
                <div class="text-VMr6Om border-class-1 poppins-normal-black-18px-2">
                    <span class="span1-fIikK1">• </span><span class="span2-fIikK1">Text</span
                    ><span class="span3-fIikK1">: The WCAG Success Criterion for Color Contrast calls for a Minimum of </span
                    ><span class="span4-fIikK1">4.5:1</span
                    ><span class="span5-fIikK1">
                    ratio for the visual presentation of text and images of text.&nbsp;&nbsp;This rule applies to all text and
                    images of text that are smaller than 18 pt or 14 pt bold.<br /><br />• </span
                    ><span class="span6-fIikK1">Large-scale text</span><span class="span7-fIikK1"> and </span
                    ><span class="span8-fIikK1">images of large-scale text</span
                    ><span class="span9-fIikK1">: should have a minimum contrast ratio of </span
                    ><span class="span10-fIikK1">3:1. </span
                    ><span class="span11-fIikK1">
                    Large-scale text is text that is 18 pt or larger, or 14 pt bold and larger.<br /><br />• </span
                    ><span class="span12-fIikK1">Logo-Type</span
                    ><span class="span13-fIikK1">: Text that is part of a logo or brand name has </span
                    ><span class="span14-fIikK1">no contrast requirement.<br /><br /></span><span class="span15-fIikK1">• </span
                    ><span class="span16-fIikK1">Incidentals</span
                    ><span class="span17-fIikK1"
                    ...
                    have </span
                    ><span class="span18-fIikK1">no contrast requirement.<br /></span><span class="span19-fIikK1">&nbsp;</span>
                </div>
                <div class="the-visibi--for-users-C61RwL valign-text-middle border-class-1 poppins-normal-black-18px">
                    Part of making a website perceivable to the visually impaired is following strict guidelines when it comes to
                ...
                <div class="the-visibi--for-users-VMr6Om valign-text-middle border-class-1 poppins-normal-black-18px">
                    Below you will see a bad example (on the left) and a good example (on the right) of color contrast ratios for
                    normal text.
                </div>
                <div class="the-visibi--for-users-mzXdH9 valign-text-middle border-class-1 poppins-normal-black-18px">
                    Below is an example of large-scale text that meets the minimum ratio for large-scale text.&nbsp;&nbsp;Notice the
                    pink color has a bit more luminance than that of the 17pt text in example 2.&nbsp;&nbsp;This is more acceptable
                ...
                <div class="the-visibi--for-users-2P4qUJ valign-text-middle border-class-1">
                    By making the text a little darker, and making the background white, we were able to just meet the minimum for
                    AA standards.
                </div>
                <div class="section-header-C61RwL">
                    <div class="five-ways---your-work-X1rVr0 valign-text-middle border-class-1 poppins-semi-bold-black-24px">
                ...
                <div class="this-text--hex-ffffff-C61RwL valign-text-middle border-class-1">
                    This text is 17 pt Helvetica Neue with a regular font weight, in Hex #CC21CC on a white background (Hex #FFFFFF)
                </div>
                <div class="paragraph-C61RwL border-class-1 poppins-normal-black-18px-2">
                    <span class="span1-AIuAkp">Example 1 (Does Not Meet AA Minimum)<br /></span
                    ><span class="span2-AIuAkp"><br />The example above has a contrast ratio of </span
                    ><span class="span3-AIuAkp">1.49:1<br /></span>
                </div>
                <div class="paragraph-VMr6Om border-class-1 poppins-normal-black-18px-2">
                    <span class="span1-APjJZp">Example 2 (Meets AA Minimum)<br /></span
                    ><span class="span2-APjJZp"><br />The above has a contrast ratio of </span
                    ><span class="span3-APjJZp">4.5:1</span><span class="span4-APjJZp"> exactly</span>
                </div>
                ...
                <div class="slackrgb-2-C61RwL">
                    <img class="vector-HnZ9Ub" src="img/vector-4@2x.png" />
                    <img class="vector-1gbtub" src="img/vector-5@2x.png" />
                    <img class="vector-x5HsnM" src="img/vector-6@2x.png" />
                    <img class="vector-UcAU16" src="img/vector-7@2x.png" />
                    <img class="vector-kAwM0S" src="img/vector-8@2x.png" />
                    <img class="vector-s9THO7" src="img/vector-9@2x.png" />
                    <img class="vector-4xMZ0u" src="img/vector-10@2x.png" />
                    <img class="vector-nMSbRE" src="img/vector-11@2x.png" />
                    <img class="vector-yXgpL3" src="img/vector-12@2x.png" />
                    <img class="vector-c3y5OG" src="img/vector-13@2x.png" />
                    <img class="vector-eDjr0x" src="img/vector-14@2x.png" />
                    <img class="vector-Kw3YKU" src="img/vector-15@2x.png" />
                    <img class="vector-v1ZexB" src="img/vector-16@2x.png" />
                </div>
                <div class="rectangle-44-C61RwL"></div>
                <div class="color-cont-le-image-1-C61RwL">
                    <img class="incidental-text-image-jAorUh" src="img/incidental-text-image@2x.png" />
                </div>
                <img class="vector-C61RwL" src="img/vector@2x.png" />
                <img class="color-contrast-image-C61RwL" src="img/color-contrast-image@2x.png" />
                <div class="image-placeholder-mzXdH9"></div>
                <div class="this-text--hex-ffffff-VMr6Om valign-text-middle border-class-1">
                    This text is 18 pt Helvetica Neue with a regular font weight, in Hex #FF00FF on a white background (Hex #FFFFFF)
                </div>
                <div class="paragraph-mzXdH9 border-class-1 poppins-normal-black-18px-2">
                    <span class="span1-CSwWdx">Example 3 (Meets AA Minimum)<br /></span
                    ><span class="span2-CSwWdx"><br />The above has a contrast ratio of </span
                    ><span class="span3-CSwWdx">3.13:1</span>
                </div>
                <div class="welcome-C61RwL">
                ...
                <div class="divider-dotted-C61RwL"><img class="line-4-xv1xHo" src="img/line-4-3@1x.png" /></div>
                </div>
            </body>
            </html>
